...
<body>
  ...
  <form action="fast-scan.php" method="post" enctype="multipart/form-data">
    ...
    <input type="submit" value="Analyser l'image" name="submit">
  </form>
  ...
  <?php
    if(isset($_POST["submit"])) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
          ...
          echo '<br>';
          echo "<div display:block; margin:auto;>
          <center><img src='$target_file' alt='image' width='760px' height='760px'/></center>
              ";
        } else {
